...
from utils import load_config, create_dataloader, save_checkpoint, load_checkpoint, create_model, validate_and_save_masks
...
def main():
    ...
    parser.add_argument(
        "--config_path",
        type=str,
        default="configs/class_conditioning.yaml",
